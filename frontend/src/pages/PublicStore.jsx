...
const DEFAULT_TC = {
  sections: [
    ...
    { id:"footer",       type:"footer",       enabled:true,  settings:{ copyright:"© 2025 اسم متجرك", showNewsletter:true, showTerms:true, termsText:"الشروط والسياسات", showSocials:true, socials:{ facebook:"", instagram:"", youtube:"", tiktok:"", twitter:"", whatsapp:"" }, bgColor:"#111827", textColor:"#ffffff" } },
  ],
